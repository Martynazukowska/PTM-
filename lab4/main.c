...
#define INIT_LED 	DDRC |= (1<<PC5)  //output - wyj�cie bo nim sterujemy (DDRx gdzie x to nazwa postu)
#define LED_ON 		PORTC |= (1<<PC5)
#define LED_OFF 	PORTC &= ~(1<<PC5)

#define INIT_LED1 	DDRA |= (1<<PA0)  //output - wyj�cie bo nim sterujemy (DDRx gdzie x to nazwa postu)
...
#define INIT_LED2 	DDRA |= (1<<PA1)  //output - wyj�cie bo nim sterujemy (DDRx gdzie x to nazwa postu)
...
#define INIT_LED3 	DDRA |= (1<<PA2)  //output - wyj�cie bo nim sterujemy (DDRx gdzie x to nazwa postu)
#define LED_ON3 		PORTA |= (1<<PA2)
#define LED_OFF3 	PORTA &= ~(1<<PA2)

#define INIT_LED4 	DDRA |= (1<<PA3)  //output - wyj�cie bo nim sterujemy (DDRx gdzie x to nazwa postu)
#define LED_ON4 		PORTA |= (1<<PA3)
#define LED_OFF4 	PORTA &= ~(1<<PA3)

#define INIT_LED5 	DDRA |= (1<<PA4)  //output - wyj�cie bo nim sterujemy (DDRx gdzie x to nazwa postu)
#define LED_ON5 		PORTA |= (1<<PA4)
#define LED_OFF5 	PORTA &= ~(1<<PA4)

#define INIT_LED6 	DDRA |= (1<<PA5)  //output - wyj�cie bo nim sterujemy (DDRx gdzie x to nazwa postu)
#define LED_ON6 		PORTA |= (1<<PA5)
#define LED_OFF6 	PORTA &= ~(1<<PA5)

#define INIT_LED7 	DDRA |= (1<<PA6)  //output - wyj�cie bo nim sterujemy (DDRx gdzie x to nazwa postu)
#define LED_ON7 		PORTA |= (1<<PA6)
#define LED_OFF7 	PORTA &= ~(1<<PA6)

#define INIT_1 	DDRC |= (1<<PC3)  //output - wyj�cie bo nim sterujemy (DDRx gdzie x to nazwa postu)
#define ON_1 		PORTC |= (1<<PC3)
#define OFF_1 	PORTC &= ~(1<<PC3)

#define INIT_2 	DDRC |= (1<<PC2)  //output - wyj�cie bo nim sterujemy (DDRx gdzie x to nazwa postu)
#define ON_2 		PORTC |= (1<<PC2)
#define OFF_2 	PORTC &= ~(1<<PC2)

#define INIT_3 	DDRC |= (1<<PC1)  //output - wyj�cie bo nim sterujemy (DDRx gdzie x to nazwa postu)
#define ON_3 		PORTC |= (1<<PC1)
#define OFF_3 	PORTC &= ~(1<<PC1)

#define INIT_4 	DDRC |= (1<<PC0)  //output - wyj�cie bo nim sterujemy (DDRx gdzie x to nazwa postu)
...
int main()
{
	...
	ADCSRA |= ((1<<ADPS0) | (1<<ADPS1)); //Ustawienie preskalera na 8 (011) - ustaw czestotliwo�� na 8 
